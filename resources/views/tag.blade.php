...
<main id="main" class="main">
  <div class="pagetitle">
    <h1>Dashboard</h1>
    <nav>
      <a href="{{ route('tags') }}" class="btn btn-primary">
        <i class="fas fa-plus-circle">add tag</i>
      </a>
    </nav>
  </div>
  <form action="{{ route('tag.store') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-6 mt-3">
      <label for="tagname" class="mb-2">tagname</label>
      <input type="text" id="tagname" name="tagname" class=" @error('tagname') is-invalid @enderror form-control"
        required>
      @error('tagname')
    ...
    <div class="col-md-6 mt-3">
      ...
      <input type="text" id="tagline" name="tagline" class=" @error('tagline') is-invalid @enderror form-control"
        required>
      @error('tagline')
      <p class="invalid-feedback">{{ $message }}</p>
      @enderror
