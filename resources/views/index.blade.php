...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    {{-- <li class="nav-item">
        <a class="nav-link collapsed" href="{{ route('blogslish') }}">
    <i class="bi bi-person"></i>
    <span>Blogs</span>
    </a> --}}

    {{-- <a class="nav-link collapsed" href="{{ route('blogshow') }}">
    <i class="bi bi-person"></i>
    ...
    {{-- new --}}
    {{-- <a class="nav-link collapsed" href="{{ route('authorshow') }}">
    <i class="bi bi-person"></i>
    <span>Auther</span>
    </a> --}}

    {{-- <a class="nav-link collapsed" href="{{ route('tagshow') }}">
    <i class="bi bi-person"></i>
    <span>Tag</span>
    </a> --}}
