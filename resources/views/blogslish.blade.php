  ...
  <div class="pagetitle">
    ...
    <nav>
      <a href="{{ route('categories') }}" class="btn btn-primary">
        <i class="fas fa-plus-circle">Add Blogs</i>
      </a>
    </nav>
  </div>
  <!-- End Page Title -->
  <table class="table table-borderless datatable">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="{{route('edit', $blogs->id)}}" class="btn btn-dark">Edit</a>
          <form id="delete-blog-form-{{$blogs->id}}" action="{{route('destroy',$blogs->id)}}" method="post">
            @csrf
            @method('DELETE')
